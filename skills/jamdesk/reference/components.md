...
Architecture, flowchart, sequence, and SQL diagrams from text. Authored as a ` ```d2 ` fenced code block (no component wrapper); renders to SVG at build time with automatic light/dark theming.
